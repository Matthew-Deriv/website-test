...
autodoc_default_options = {
    'members': True,
    'undoc-members': True,
    'special-members': '__init__, _set_attributes, _set_app_details, _get_app_markup, _get_app_id, _proposal, _send, _check_connection, _check_closed, _recv_msg_handler',
